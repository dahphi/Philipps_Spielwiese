...
-- changeset RK_MAIN:1774561694291 stripComments:false logicalFilePath:SCDP/rk_main/package_specs/pck_isr_oam_umsetzungsstatus_dml.sql runAlways:false runOnChange:false replaceIfExists:true failOnError:true
