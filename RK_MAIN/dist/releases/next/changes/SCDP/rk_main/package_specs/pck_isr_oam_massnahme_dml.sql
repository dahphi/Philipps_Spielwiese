...
-- changeset RK_MAIN:1774554920544 stripComments:false logicalFilePath:SCDP/rk_main/package_specs/pck_isr_oam_massnahme_dml.sql runAlways:false runOnChange:false replaceIfExists:true failOnError:true
