...
-- changeset RK_MAIN:1774561690546 stripComments:false logicalFilePath:SCDP/rk_main/object_grants/object_grants_as_grantor.rk_main.table.databasechangelog_actions.sql runAlways:false runOnChange:false replaceIfExists:true failOnError:true
