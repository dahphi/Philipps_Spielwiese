...
-- changeset RK_MAIN:1774555708380 stripComments:false logicalFilePath:SCDP/rk_main/object_grants/object_grants_as_grantor.awh_main.view.v_hwas_awh_tab_schutz_verfuegbar.sql runAlways:false runOnChange:false replaceIfExists:true failOnError:true
