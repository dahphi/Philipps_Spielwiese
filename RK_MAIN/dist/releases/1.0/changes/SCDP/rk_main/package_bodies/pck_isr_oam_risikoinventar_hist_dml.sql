...
-- changeset RK_MAIN:1774561693506 stripComments:false logicalFilePath:SCDP/rk_main/package_bodies/pck_isr_oam_risikoinventar_hist_dml.sql runAlways:false runOnChange:false replaceIfExists:true failOnError:true
-- sqlcl_snapshot RK_MAIN/src/database/rk_main/package_bodies/pck_isr_oam_risikoinventar_hist_dml.sql:null:543601103c893897239fad6e8d675bd0cd3b1873:create
