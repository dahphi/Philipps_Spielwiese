...
-- changeset RK_MAIN:1774561694511 stripComments:false logicalFilePath:SCDP/rk_main/synonyms/awh_tab_geschaeftskrit.sql runAlways:false runOnChange:false replaceIfExists:true failOnError:true
