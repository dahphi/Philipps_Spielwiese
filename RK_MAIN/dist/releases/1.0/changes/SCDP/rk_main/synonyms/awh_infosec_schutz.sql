...
-- changeset RK_MAIN:1774554920882 stripComments:false logicalFilePath:SCDP/rk_main/synonyms/awh_infosec_schutz.sql runAlways:false runOnChange:false replaceIfExists:true failOnError:true
