...
-- changeset RK_MAIN:1774554920894 stripComments:false logicalFilePath:SCDP/rk_main/synonyms/awh_mtn_sys_grt.sql runAlways:false runOnChange:false replaceIfExists:true failOnError:true
