...
-- changeset RK_MAIN:1774561694470 stripComments:false logicalFilePath:SCDP/rk_main/synonyms/awh_infosec_anlagenkat.sql runAlways:false runOnChange:false replaceIfExists:true failOnError:true
