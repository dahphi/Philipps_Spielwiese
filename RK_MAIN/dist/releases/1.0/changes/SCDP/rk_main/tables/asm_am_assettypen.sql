...
-- changeset RK_MAIN:1774554921013 stripComments:false logicalFilePath:SCDP/rk_main/tables/asm_am_assettypen.sql runAlways:false runOnChange:false replaceIfExists:true failOnError:true
