...
-- changeset RK_MAIN:1774561694617 stripComments:false logicalFilePath:SCDP/rk_main/tables/asm_am_erkenntnisquellen.sql runAlways:false runOnChange:false replaceIfExists:true failOnError:true
