...
-- changeset rk_main:1774554916096 stripComments:false logicalFilePath:SCDP/rk_main/comments/isr_assettypen_gefaehrdungkat.sql runAlways:false runOnChange:false replaceIfExists:true failOnError:true
