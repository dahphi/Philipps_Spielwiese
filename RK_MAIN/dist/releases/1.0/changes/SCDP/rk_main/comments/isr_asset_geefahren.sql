...
-- changeset rk_main:1774561689931 stripComments:false logicalFilePath:SCDP/rk_main/comments/isr_asset_geefahren.sql runAlways:false runOnChange:false replaceIfExists:true failOnError:true
