...
-- changeset rk_main:1774561690327 stripComments:false logicalFilePath:SCDP/rk_main/comments/isr_oam_umsetzungsstatus.sql runAlways:false runOnChange:false replaceIfExists:true failOnError:true
