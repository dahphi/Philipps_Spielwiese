...
-- changeset rk_main:1774554916345 stripComments:false logicalFilePath:SCDP/rk_main/comments/isr_oam_massnahmenkatalog.sql runAlways:false runOnChange:false replaceIfExists:true failOnError:true
