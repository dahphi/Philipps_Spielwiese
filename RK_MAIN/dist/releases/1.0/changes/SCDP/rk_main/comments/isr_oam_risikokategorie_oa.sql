...
-- changeset rk_main:1774561690292 stripComments:false logicalFilePath:SCDP/rk_main/comments/isr_oam_risikokategorie_oa.sql runAlways:false runOnChange:false replaceIfExists:true failOnError:true
