...
-- changeset rk_main:1774554916145 stripComments:false logicalFilePath:SCDP/rk_main/comments/isr_brm_gefaehrdung.sql runAlways:false runOnChange:false replaceIfExists:true failOnError:true
