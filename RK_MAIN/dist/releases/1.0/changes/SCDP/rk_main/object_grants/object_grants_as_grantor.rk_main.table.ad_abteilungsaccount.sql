...
-- changeset RK_MAIN:1774561690489 stripComments:false logicalFilePath:SCDP/rk_main/object_grants/object_grants_as_grantor.rk_main.table.ad_abteilungsaccount.sql runAlways:false runOnChange:false replaceIfExists:true failOnError:true
