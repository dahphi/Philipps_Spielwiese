...
-- changeset RK_MAIN:1774554916884 stripComments:false logicalFilePath:SCDP/rk_main/object_grants/object_grants_as_grantor.rk_main.table.isr_oam_massnahmenkatalog_hist.sql runAlways:false runOnChange:false replaceIfExists:true failOnError:true
