...
-- changeset RK_MAIN:1774554921821 stripComments:false logicalFilePath:SCDP/rk_main/triggers/trg_ris_uid_netto2_reset.sql runAlways:false runOnChange:false replaceIfExists:true failOnError:true
