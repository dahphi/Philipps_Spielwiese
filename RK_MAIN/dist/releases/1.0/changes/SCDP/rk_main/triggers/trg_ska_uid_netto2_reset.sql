...
-- changeset RK_MAIN:1774554921833 stripComments:false logicalFilePath:SCDP/rk_main/triggers/trg_ska_uid_netto2_reset.sql runAlways:false runOnChange:false replaceIfExists:true failOnError:true
