...
-- changeset RK_MAIN:1774554920444 stripComments:false logicalFilePath:SCDP/rk_main/package_specs/pck_isr_brm_schwachstellenkat_dml.sql runAlways:false runOnChange:false replaceIfExists:true failOnError:true
