...
-- changeset RK_MAIN:1774561694025 stripComments:false logicalFilePath:SCDP/rk_main/package_specs/pck_asm_isr_assets_risiken_hist_dml.sql runAlways:false runOnChange:false replaceIfExists:true failOnError:true
