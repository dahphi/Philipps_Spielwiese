...
-- changeset RK_MAIN:1774554920532 stripComments:false logicalFilePath:SCDP/rk_main/package_specs/pck_isr_oam_adressat_dml_hist.sql runAlways:false runOnChange:false replaceIfExists:true failOnError:true
