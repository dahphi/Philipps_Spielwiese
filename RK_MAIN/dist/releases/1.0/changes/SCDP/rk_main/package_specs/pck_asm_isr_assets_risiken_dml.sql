...
-- changeset RK_MAIN:1774554920374 stripComments:false logicalFilePath:SCDP/rk_main/package_specs/pck_asm_isr_assets_risiken_dml.sql runAlways:false runOnChange:false replaceIfExists:true failOnError:true
