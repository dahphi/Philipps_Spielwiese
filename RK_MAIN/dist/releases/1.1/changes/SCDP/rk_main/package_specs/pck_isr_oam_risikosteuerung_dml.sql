...
-- changeset RK_MAIN:1774555712750 stripComments:false logicalFilePath:SCDP/rk_main/package_specs/pck_isr_oam_risikosteuerung_dml.sql runAlways:false runOnChange:false replaceIfExists:true failOnError:true
