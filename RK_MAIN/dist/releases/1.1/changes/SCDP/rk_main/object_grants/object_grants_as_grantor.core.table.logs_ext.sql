...
-- changeset RK_MAIN:1774555708429 stripComments:false logicalFilePath:SCDP/rk_main/object_grants/object_grants_as_grantor.core.table.logs_ext.sql runAlways:false runOnChange:false replaceIfExists:true failOnError:true
