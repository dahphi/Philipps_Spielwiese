...
-- changeset RK_MAIN:1774555709204 stripComments:false logicalFilePath:SCDP/rk_main/object_grants/object_grants_as_grantor.rk_main.table.isr_massnahme_kontext.sql runAlways:false runOnChange:false replaceIfExists:true failOnError:true
