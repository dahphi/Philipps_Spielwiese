...
-- changeset RK_MAIN:1774555712924 stripComments:false logicalFilePath:SCDP/rk_main/synonyms/awh_erheb_1_fachbereich.sql runAlways:false runOnChange:false replaceIfExists:true failOnError:true
