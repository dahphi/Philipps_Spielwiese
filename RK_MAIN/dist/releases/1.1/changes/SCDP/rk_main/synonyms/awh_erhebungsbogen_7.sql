...
-- changeset RK_MAIN:1774555712929 stripComments:false logicalFilePath:SCDP/rk_main/synonyms/awh_erhebungsbogen_7.sql runAlways:false runOnChange:false replaceIfExists:true failOnError:true
