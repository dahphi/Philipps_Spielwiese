...
-- changeset RK_MAIN:1774555712982 stripComments:false logicalFilePath:SCDP/rk_main/synonyms/awh_tab_infosec_sys_status.sql runAlways:false runOnChange:false replaceIfExists:true failOnError:true
