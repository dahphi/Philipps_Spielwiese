...
-- changeset RK_MAIN:1774555712993 stripComments:false logicalFilePath:SCDP/rk_main/synonyms/awh_tab_schutz_integritaet.sql runAlways:false runOnChange:false replaceIfExists:true failOnError:true
