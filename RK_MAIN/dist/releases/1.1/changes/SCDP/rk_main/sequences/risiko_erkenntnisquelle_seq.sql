...
-- changeset RK_MAIN:1774555712918 stripComments:false logicalFilePath:SCDP/rk_main/sequences/risiko_erkenntnisquelle_seq.sql runAlways:false runOnChange:false replaceIfExists:true failOnError:true
