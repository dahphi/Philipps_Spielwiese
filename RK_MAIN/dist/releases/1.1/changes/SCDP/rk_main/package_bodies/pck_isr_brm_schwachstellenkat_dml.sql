...
-- changeset RK_MAIN:1774555710383 stripComments:false logicalFilePath:SCDP/rk_main/package_bodies/pck_isr_brm_schwachstellenkat_dml.sql runAlways:false runOnChange:false replaceIfExists:true failOnError:true
