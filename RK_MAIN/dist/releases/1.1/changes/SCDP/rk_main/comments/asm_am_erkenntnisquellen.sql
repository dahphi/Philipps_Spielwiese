...
-- changeset rk_main:1774555708520 stripComments:false logicalFilePath:SCDP/rk_main/comments/asm_am_erkenntnisquellen.sql runAlways:false runOnChange:false replaceIfExists:true failOnError:true
