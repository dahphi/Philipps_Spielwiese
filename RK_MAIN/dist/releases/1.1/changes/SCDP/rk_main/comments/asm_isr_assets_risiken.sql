...
-- changeset rk_main:1774555708537 stripComments:false logicalFilePath:SCDP/rk_main/comments/asm_isr_assets_risiken.sql runAlways:false runOnChange:false replaceIfExists:true failOnError:true
