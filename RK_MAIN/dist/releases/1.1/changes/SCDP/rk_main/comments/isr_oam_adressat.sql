...
-- changeset rk_main:1774555708745 stripComments:false logicalFilePath:SCDP/rk_main/comments/isr_oam_adressat.sql runAlways:false runOnChange:false replaceIfExists:true failOnError:true
