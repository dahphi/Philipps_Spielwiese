...
-- changeset RK_MAIN:1774555708975 stripComments:false logicalFilePath:SCDP/rk_main/indexes/asm_am_assettypen_uk1.sql runAlways:false runOnChange:false replaceIfExists:true failOnError:true
