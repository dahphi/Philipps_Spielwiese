...
-- changeset RK_MAIN:1774555712889 stripComments:false logicalFilePath:SCDP/rk_main/ref_constraints/risiko_erkenntnisquelle_fk_ekq.sql runAlways:false runOnChange:false replaceIfExists:true failOnError:true
