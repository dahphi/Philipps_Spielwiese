...
-- changeset rk_main:1774555708506 stripComments:false logicalFilePath:SCDP/rk_main/comments/asm_am_assettypen.sql runAlways:false runOnChange:false replaceIfExists:true failOnError:true
