...
-- changeset rk_main:1774555708889 stripComments:false logicalFilePath:SCDP/rk_main/comments/isr_oam_risikokategorie_oa.sql runAlways:false runOnChange:false replaceIfExists:true failOnError:true
