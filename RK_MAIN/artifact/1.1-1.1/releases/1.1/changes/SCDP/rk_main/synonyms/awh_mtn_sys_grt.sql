...
-- changeset RK_MAIN:1774555712952 stripComments:false logicalFilePath:SCDP/rk_main/synonyms/awh_mtn_sys_grt.sql runAlways:false runOnChange:false replaceIfExists:true failOnError:true
