...
-- changeset RK_MAIN:1774555712958 stripComments:false logicalFilePath:SCDP/rk_main/synonyms/awh_mtn_sys_gvb.sql runAlways:false runOnChange:false replaceIfExists:true failOnError:true
