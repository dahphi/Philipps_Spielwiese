...
-- changeset RK_MAIN:1774555713691 stripComments:false logicalFilePath:SCDP/rk_main/tables/isr_oam_risikokategorie_oa.sql runAlways:false runOnChange:false replaceIfExists:true failOnError:true
