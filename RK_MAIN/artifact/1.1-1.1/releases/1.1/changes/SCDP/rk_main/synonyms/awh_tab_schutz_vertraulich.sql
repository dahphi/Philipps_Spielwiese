...
-- changeset RK_MAIN:1774555713004 stripComments:false logicalFilePath:SCDP/rk_main/synonyms/awh_tab_schutz_vertraulich.sql runAlways:false runOnChange:false replaceIfExists:true failOnError:true
