...
-- changeset rk_main:1774555708951 stripComments:false logicalFilePath:SCDP/rk_main/comments/isr_wirkbereich.sql runAlways:false runOnChange:false replaceIfExists:true failOnError:true
