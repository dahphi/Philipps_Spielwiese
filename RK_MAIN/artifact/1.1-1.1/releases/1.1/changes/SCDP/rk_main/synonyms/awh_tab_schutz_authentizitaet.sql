...
-- changeset RK_MAIN:1774555712987 stripComments:false logicalFilePath:SCDP/rk_main/synonyms/awh_tab_schutz_authentizitaet.sql runAlways:false runOnChange:false replaceIfExists:true failOnError:true
