...
-- changeset rk_main:1774555708659 stripComments:false logicalFilePath:SCDP/rk_main/comments/isr_brm_schwachstellenkat.sql runAlways:false runOnChange:false replaceIfExists:true failOnError:true
