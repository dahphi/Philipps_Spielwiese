...
-- changeset RK_MAIN:1774555712894 stripComments:false logicalFilePath:SCDP/rk_main/ref_constraints/risiko_erkenntnisquelle_fk_rsk.sql runAlways:false runOnChange:false replaceIfExists:true failOnError:true
