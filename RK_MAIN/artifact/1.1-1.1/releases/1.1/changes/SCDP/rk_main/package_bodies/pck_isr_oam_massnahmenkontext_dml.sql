...
-- changeset RK_MAIN:1774555711626 stripComments:false logicalFilePath:SCDP/rk_main/package_bodies/pck_isr_oam_massnahmenkontext_dml.sql runAlways:false runOnChange:false replaceIfExists:true failOnError:true
