...
-- changeset RK_MAIN:1774555713713 stripComments:false logicalFilePath:SCDP/rk_main/tables/isr_oam_risikosteuerung.sql runAlways:false runOnChange:false replaceIfExists:true failOnError:true
