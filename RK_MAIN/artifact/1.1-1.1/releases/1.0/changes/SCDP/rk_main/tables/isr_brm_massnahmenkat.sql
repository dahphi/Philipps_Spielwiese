...
-- changeset RK_MAIN:1774554921194 stripComments:false logicalFilePath:SCDP/rk_main/tables/isr_brm_massnahmenkat.sql runAlways:false runOnChange:false replaceIfExists:true failOnError:true
