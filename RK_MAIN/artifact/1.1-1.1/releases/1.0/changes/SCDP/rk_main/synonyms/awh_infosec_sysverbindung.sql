...
-- changeset RK_MAIN:1774554920888 stripComments:false logicalFilePath:SCDP/rk_main/synonyms/awh_infosec_sysverbindung.sql runAlways:false runOnChange:false replaceIfExists:true failOnError:true
