...
-- changeset RK_MAIN:1774554920954 stripComments:false logicalFilePath:SCDP/rk_main/synonyms/awh_technikbewertung.sql runAlways:false runOnChange:false replaceIfExists:true failOnError:true
