...
-- changeset rk_main:1774554916112 stripComments:false logicalFilePath:SCDP/rk_main/comments/isr_auswirkung.sql runAlways:false runOnChange:false replaceIfExists:true failOnError:true
