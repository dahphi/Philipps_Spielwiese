...
-- changeset rk_main:1774554916463 stripComments:false logicalFilePath:SCDP/rk_main/comments/isr_oam_risikosteuerung.sql runAlways:false runOnChange:false replaceIfExists:true failOnError:true
