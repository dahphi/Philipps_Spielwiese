...
-- changeset RK_MAIN:1774554915912 stripComments:false logicalFilePath:SCDP/rk_main/object_grants/object_grants_as_grantor.awh_main.view.v_hwas_awh_tab_schutz_vertraulich.sql runAlways:false runOnChange:false replaceIfExists:true failOnError:true
