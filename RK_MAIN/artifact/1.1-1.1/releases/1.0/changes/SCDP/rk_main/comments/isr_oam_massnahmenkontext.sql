...
-- changeset rk_main:1774554916361 stripComments:false logicalFilePath:SCDP/rk_main/comments/isr_oam_massnahmenkontext.sql runAlways:false runOnChange:false replaceIfExists:true failOnError:true
