...
-- changeset RK_MAIN:1774554915988 stripComments:false logicalFilePath:SCDP/rk_main/object_grants/object_grants_as_grantor.rk_apex.view.v_risikorelevante_assets_new.sql runAlways:false runOnChange:false replaceIfExists:true failOnError:true
