...
-- changeset RK_MAIN:1774554915956 stripComments:false logicalFilePath:SCDP/rk_main/object_grants/object_grants_as_grantor.core.table.logs.sql runAlways:false runOnChange:false replaceIfExists:true failOnError:true
