...
-- changeset RK_MAIN:1774554920924 stripComments:false logicalFilePath:SCDP/rk_main/synonyms/awh_tab_infosec_sys_status.sql runAlways:false runOnChange:false replaceIfExists:true failOnError:true
