...
comment on column pob_tracking.extra is
...
comment on column pob_tracking.id is
    'Technischer PK (IDENTITY)';

comment on column pob_tracking.request is
    'Submit-Aktion (aktueller Wert von :REQUEST)';

comment on column pob_tracking.scope is
...
comment on column pob_tracking.task is
...
-- sqlcl_snapshot {"hash":"eac2699f423f9def093171d65d1b16bdeaf30f87","type":"COMMENT","name":"pob_tracking","schemaName":"roma_main","sxml":""}