...
comment on column ftth_ws_sync_preorders.account_sepamandate is
...
comment on column ftth_ws_sync_preorders.apex$row_sync_timestamp is
    'Automatisch erzeugte Spalte (wird von APEX zur Protokollierung der REST-Source-Synchronisierung verwendet)';

comment on column ftth_ws_sync_preorders.apex$sync_step_static_id is
    'Automatisch erzeugte Spalte (wird von APEX zur Protokollierung der REST-Source-Synchronisierung verwendet)';

comment on column ftth_ws_sync_preorders.availability_date is
    'Datum der Verfügbarkeit des Produkts an der Installationsadrese';

comment on column ftth_ws_sync_preorders.cancelled_by is
...
comment on column ftth_ws_sync_preorders.cancel_date is
...
comment on column ftth_ws_sync_preorders.customernumber is
    'FTTH-ID=100, JSON-PATH=customerNumber, LABEL=Kunden-Nr/KNr., APEX=P20_KUNDENNUMMER, STATUS=OK';

comment on column ftth_ws_sync_preorders.customer_birthdate is
...
comment on column ftth_ws_sync_preorders.landlord_businessorname is
...
comment on column ftth_ws_sync_preorders.landlord_phone_countrycode is
...
comment on column ftth_ws_sync_preorders.landlord_phone_number is
...
comment on column ftth_ws_sync_preorders.manual_transfer is
...
comment on column ftth_ws_sync_preorders.ont_provider is
    'Beschreibt, wer den ONT (Optischer Netzwerkterminator) bereitstellt. Erlaubte Werte sind NETCOLOGNE|BYOD|NONE';

comment on column ftth_ws_sync_preorders.process_lock_last_modified is
...
comment on column ftth_ws_sync_preorders.providerchg_contract_cancelled is
...
comment on column ftth_ws_sync_preorders.providerchg_current_provider is
...
comment on column ftth_ws_sync_preorders.providerchg_keep_phone_number is
...
comment on column ftth_ws_sync_preorders.providerchg_owner_name_first is
...
comment on column ftth_ws_sync_preorders.providerchg_owner_name_last is
...
comment on column ftth_ws_sync_preorders.providerchg_phone_number is
