comment on table ftth_dubletten_bewertung is
...
comment on column ftth_dubletten_bewertung.aktuell is
...
comment on column ftth_dubletten_bewertung.bewertung is
    'Kategorie für die Bewertung. Stand 2023-01: G= gewollte Dublette, W= klären/Wiedervorlage, X= kein Zusammenhang';

comment on column ftth_dubletten_bewertung.datum is
    'Wann wurde diese Bewertung angelegt';

comment on column ftth_dubletten_bewertung.fuzzy_rowid is
...
comment on column ftth_dubletten_bewertung.id is
    'Technischer PK (Identity)';

comment on column ftth_dubletten_bewertung.knr0 is
    'Kundennummer, mit der in Fuzzy gesucht wurde';

comment on column ftth_dubletten_bewertung.knr1 is
    'Kundennummer des Fuzzy-Ergebnisses';

comment on column ftth_dubletten_bewertung.kommentar is
    'Optionaler Bearbeitungsvermerk zu dieser Bewertung';

comment on column ftth_dubletten_bewertung.username is
    'APEX-Benutzer:in, die diesen Datensatz angelegt hat';


-- sqlcl_snapshot {"hash":"6e141303df8981e11c0410394b7362a5f1bdf135","type":"COMMENT","name":"ftth_dubletten_bewertung","schemaName":"roma_main","sxml":""}