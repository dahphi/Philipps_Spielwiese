prompt --application/shared_components/user_interface/lovs/technologie
begin
--   Manifest
--     TECHNOLOGIE
--   Manifest End
...
wwv_flow_imp_shared.create_list_of_values(
 p_id=>wwv_flow_imp.id(193718393194807963)
,p_lov_name=>'TECHNOLOGIE'
,p_lov_query=>wwv_flow_string.join(wwv_flow_t_varchar2(
'select dnsttp_bez d , dnsttp_lfd_nr r',
'  from tab_dienst_typ',
' where dnsttp_lfd_nr in (70,51,71,80)'))
,p_source_type=>'SQL'
,p_location=>'LOCAL'
