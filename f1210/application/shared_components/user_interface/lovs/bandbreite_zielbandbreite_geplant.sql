prompt --application/shared_components/user_interface/lovs/bandbreite_zielbandbreite_geplant
begin
--   Manifest
--     BANDBREITE (ZIELBANDBREITE_GEPLANT)
--   Manifest End
...
wwv_flow_imp_shared.create_list_of_values(
 p_id=>wwv_flow_imp.id(199647326116498520)
,p_lov_name=>'BANDBREITE (ZIELBANDBREITE_GEPLANT)'
