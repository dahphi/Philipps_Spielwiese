prompt --application/shared_components/user_interface/templates/page/standard_without_footer
begin
--   Manifest
--     TEMPLATE: STANDARD_WITHOUT_FOOTER
--   Manifest End
...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(79256445261925677)
,p_theme_id=>42
,p_name=>'Standard without Footer'
,p_internal_name=>'STANDARD_WITHOUT_FOOTER'
,p_is_popup=>false
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(79256870603925682)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(79257358502925683)
,p_page_template_id=>wwv_flow_imp.id(79256445261925677)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(79257903819925683)
,p_page_template_id=>wwv_flow_imp.id(79256445261925677)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(79258373979925684)
,p_page_template_id=>wwv_flow_imp.id(79256445261925677)
,p_name=>'Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(79258862288925684)
,p_page_template_id=>wwv_flow_imp.id(79256445261925677)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(79259339028925684)
,p_page_template_id=>wwv_flow_imp.id(79256445261925677)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(79259836320925684)
,p_page_template_id=>wwv_flow_imp.id(79256445261925677)
,p_name=>'Footer'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(79260407033925684)
,p_page_template_id=>wwv_flow_imp.id(79256445261925677)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(79260921207925684)
,p_page_template_id=>wwv_flow_imp.id(79256445261925677)
,p_name=>'Banner'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(79261368061925685)
,p_page_template_id=>wwv_flow_imp.id(79256445261925677)
