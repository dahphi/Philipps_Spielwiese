...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(236563856669961957)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(240001318346982246)
,p_plug_template_id=>wwv_flow_imp.id(236563856669961957)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(240001838783982246)
,p_plug_template_id=>wwv_flow_imp.id(236563856669961957)
,p_name=>'Tabs'
