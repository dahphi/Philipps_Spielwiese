...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(236544861131961951)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(165994182657654037)
,p_plug_template_id=>wwv_flow_imp.id(236544861131961951)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(165994345680654037)
,p_plug_template_id=>wwv_flow_imp.id(236544861131961951)
,p_name=>'Sub Regions'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(165994432721654037)
,p_plug_template_id=>wwv_flow_imp.id(236544861131961951)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(165994536417654037)
,p_plug_template_id=>wwv_flow_imp.id(236544861131961951)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(165994582969654037)
,p_plug_template_id=>wwv_flow_imp.id(236544861131961951)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(165994698441654037)
,p_plug_template_id=>wwv_flow_imp.id(236544861131961951)
,p_name=>'Change'
