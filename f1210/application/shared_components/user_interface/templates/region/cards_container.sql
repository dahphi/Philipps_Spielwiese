...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(236529219157961946)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(165991998958654037)
,p_plug_template_id=>wwv_flow_imp.id(236529219157961946)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(165992120807654037)
,p_plug_template_id=>wwv_flow_imp.id(236529219157961946)
,p_name=>'Sub Regions'
