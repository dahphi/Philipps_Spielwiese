...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(236547199245961951)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(165994841353654037)
,p_plug_template_id=>wwv_flow_imp.id(236547199245961951)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(165994926903654037)
,p_plug_template_id=>wwv_flow_imp.id(236547199245961951)
,p_name=>'Sub Regions'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(165995046868654037)
,p_plug_template_id=>wwv_flow_imp.id(236547199245961951)
,p_name=>'Next'
,p_placeholder=>'NEXT'
