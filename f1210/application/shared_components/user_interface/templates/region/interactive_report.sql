...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(236555122295961954)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(165996681076654037)
,p_plug_template_id=>wwv_flow_imp.id(236555122295961954)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(165996855238654037)
,p_plug_template_id=>wwv_flow_imp.id(236555122295961954)
,p_name=>'Sub Regions'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(165996943346654037)
,p_plug_template_id=>wwv_flow_imp.id(236555122295961954)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(165997040802654037)
,p_plug_template_id=>wwv_flow_imp.id(236555122295961954)
,p_name=>'Previous'
