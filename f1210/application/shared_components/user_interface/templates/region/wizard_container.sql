...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(236567640166961958)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(165988689725654037)
,p_plug_template_id=>wwv_flow_imp.id(236567640166961958)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(165988950506654037)
,p_plug_template_id=>wwv_flow_imp.id(236567640166961958)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(165989005419654037)
,p_plug_template_id=>wwv_flow_imp.id(236567640166961958)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(165989108724654037)
,p_plug_template_id=>wwv_flow_imp.id(236567640166961958)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(240008951184982252)
,p_plug_template_id=>wwv_flow_imp.id(236567640166961958)
