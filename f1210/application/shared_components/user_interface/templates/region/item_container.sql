...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(88836393416802469)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(88836736617802493)
,p_plug_template_id=>wwv_flow_imp.id(88836393416802469)
,p_name=>'Item'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(88837288037802494)
,p_plug_template_id=>wwv_flow_imp.id(88836393416802469)
,p_name=>'Button End'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(88837753582802495)
,p_plug_template_id=>wwv_flow_imp.id(88836393416802469)
,p_name=>'Button Start'
