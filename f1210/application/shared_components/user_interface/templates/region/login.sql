...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(236555710030961955)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(165997240001654037)
,p_plug_template_id=>wwv_flow_imp.id(236555710030961955)
,p_name=>'Sub Regions'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(165997349279654037)
,p_plug_template_id=>wwv_flow_imp.id(236555710030961955)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(165997455469654037)
,p_plug_template_id=>wwv_flow_imp.id(236555710030961955)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(165997475125654037)
,p_plug_template_id=>wwv_flow_imp.id(236555710030961955)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(239978754804982226)
,p_plug_template_id=>wwv_flow_imp.id(236555710030961955)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>false
