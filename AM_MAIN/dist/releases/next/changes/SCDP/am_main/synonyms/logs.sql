...
-- changeset AM_MAIN:1774556572447 stripComments:false logicalFilePath:SCDP/am_main/synonyms/logs.sql runAlways:false runOnChange:false replaceIfExists:true failOnError:true
