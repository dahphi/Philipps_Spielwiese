...
-- changeset AM_MAIN:1774557120296 stripComments:false logicalFilePath:SCDP/am_main/package_specs/pck_hwdb_hosts_import_hist_dml.sql runAlways:false runOnChange:false replaceIfExists:true failOnError:true
