...
-- changeset AM_MAIN:1774557122212 stripComments:false logicalFilePath:SCDP/am_main/views/v_awh_hwas_elem_geraet.sql runAlways:false runOnChange:false replaceIfExists:true failOnError:true
