...
-- changeset AM_MAIN:1774556568220 stripComments:false logicalFilePath:SCDP/am_main/object_grants/object_grants_as_grantor.am_main.table.sap_lieferanten_kreditoren_nr.sql runAlways:false runOnChange:false replaceIfExists:true failOnError:true
