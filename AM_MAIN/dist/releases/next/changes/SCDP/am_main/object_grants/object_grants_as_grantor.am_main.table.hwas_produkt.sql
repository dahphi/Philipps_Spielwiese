...
-- changeset AM_MAIN:1774557115944 stripComments:false logicalFilePath:SCDP/am_main/object_grants/object_grants_as_grantor.am_main.table.hwas_produkt.sql runAlways:false runOnChange:false replaceIfExists:true failOnError:true
