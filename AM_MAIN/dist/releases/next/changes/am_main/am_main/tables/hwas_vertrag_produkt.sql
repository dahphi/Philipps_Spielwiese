...
-- changeset AM_MAIN:1774600126988 stripComments:false logicalFilePath:am_main/am_main/tables/hwas_vertrag_produkt.sql runAlways:false runOnChange:false replaceIfExists:true failOnError:true
