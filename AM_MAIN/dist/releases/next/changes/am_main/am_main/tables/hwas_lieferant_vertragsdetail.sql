...
-- changeset AM_MAIN:1774600125641 stripComments:false logicalFilePath:am_main/am_main/tables/hwas_lieferant_vertragsdetail.sql runAlways:false runOnChange:false replaceIfExists:true failOnError:true
