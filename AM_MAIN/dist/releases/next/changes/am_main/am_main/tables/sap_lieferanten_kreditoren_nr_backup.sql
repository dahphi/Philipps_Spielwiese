...
-- changeset AM_MAIN:1774600127864 stripComments:false logicalFilePath:am_main/am_main/tables/sap_lieferanten_kreditoren_nr_backup.sql runAlways:false runOnChange:false replaceIfExists:true failOnError:true
