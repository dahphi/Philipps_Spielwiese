...
-- changeset AM_MAIN:1774600122883 stripComments:false logicalFilePath:am_main/am_main/synonyms/logs.sql runAlways:false runOnChange:false replaceIfExists:true failOnError:true
