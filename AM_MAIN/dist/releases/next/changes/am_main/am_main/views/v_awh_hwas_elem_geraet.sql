...
-- changeset AM_MAIN:1774600128739 stripComments:false logicalFilePath:am_main/am_main/views/v_awh_hwas_elem_geraet.sql runAlways:false runOnChange:false replaceIfExists:true failOnError:true
