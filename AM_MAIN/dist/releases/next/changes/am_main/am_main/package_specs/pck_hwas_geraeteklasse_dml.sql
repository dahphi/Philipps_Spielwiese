...
-- changeset AM_MAIN:1774600120739 stripComments:false logicalFilePath:am_main/am_main/package_specs/pck_hwas_geraeteklasse_dml.sql runAlways:false runOnChange:false replaceIfExists:true failOnError:true
