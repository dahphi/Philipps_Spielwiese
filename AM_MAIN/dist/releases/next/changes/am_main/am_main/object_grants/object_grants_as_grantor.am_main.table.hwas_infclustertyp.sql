...
-- changeset AM_MAIN:1774600100726 stripComments:false logicalFilePath:am_main/am_main/object_grants/object_grants_as_grantor.am_main.table.hwas_infclustertyp.sql runAlways:false runOnChange:false replaceIfExists:true failOnError:true
