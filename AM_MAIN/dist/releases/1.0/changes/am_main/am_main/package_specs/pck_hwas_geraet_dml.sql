...
-- changeset AM_MAIN:1774600120690 stripComments:false logicalFilePath:am_main/am_main/package_specs/pck_hwas_geraet_dml.sql runAlways:false runOnChange:false replaceIfExists:true failOnError:true
-- sqlcl_snapshot AM_MAIN/src/database/am_main/package_specs/pck_hwas_geraet_dml.sql:null:b84096afa18d68cd5f1637f4d0fb25585711e4f6:create
