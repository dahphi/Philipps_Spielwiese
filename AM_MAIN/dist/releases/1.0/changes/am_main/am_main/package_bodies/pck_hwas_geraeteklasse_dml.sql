...
-- changeset AM_MAIN:1774600109507 stripComments:false logicalFilePath:am_main/am_main/package_bodies/pck_hwas_geraeteklasse_dml.sql runAlways:false runOnChange:false replaceIfExists:true failOnError:true
-- sqlcl_snapshot AM_MAIN/src/database/am_main/package_bodies/pck_hwas_geraeteklasse_dml.sql:null:db3429a0743d7056cf0b843ffdf949762e055966:create
