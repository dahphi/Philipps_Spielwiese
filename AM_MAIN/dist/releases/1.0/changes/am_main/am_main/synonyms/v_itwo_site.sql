...
-- changeset AM_MAIN:1774600123213 stripComments:false logicalFilePath:am_main/am_main/synonyms/v_itwo_site.sql runAlways:false runOnChange:false replaceIfExists:true failOnError:true
