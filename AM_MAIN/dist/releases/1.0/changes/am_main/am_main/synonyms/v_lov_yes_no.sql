...
-- changeset AM_MAIN:1774600123233 stripComments:false logicalFilePath:am_main/am_main/synonyms/v_lov_yes_no.sql runAlways:false runOnChange:false replaceIfExists:true failOnError:true
