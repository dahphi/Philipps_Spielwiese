...
-- changeset AM_MAIN:1774600122442 stripComments:false logicalFilePath:am_main/am_main/ref_constraints/fk_sap_liefkred_lie.sql runAlways:false runOnChange:false replaceIfExists:true failOnError:true
