...
-- changeset AM_MAIN:1774600127892 stripComments:false logicalFilePath:am_main/am_main/tables/sap_warengruppen.sql runAlways:false runOnChange:false replaceIfExists:true failOnError:true
