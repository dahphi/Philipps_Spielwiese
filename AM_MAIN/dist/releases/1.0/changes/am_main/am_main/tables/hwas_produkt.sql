...
-- changeset AM_MAIN:1774600125973 stripComments:false logicalFilePath:am_main/am_main/tables/hwas_produkt.sql runAlways:false runOnChange:false replaceIfExists:true failOnError:true
