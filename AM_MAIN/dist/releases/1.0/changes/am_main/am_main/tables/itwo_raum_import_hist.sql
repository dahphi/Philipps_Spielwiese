...
-- changeset AM_MAIN:1774600127289 stripComments:false logicalFilePath:am_main/am_main/tables/itwo_raum_import_hist.sql runAlways:false runOnChange:false replaceIfExists:true failOnError:true
