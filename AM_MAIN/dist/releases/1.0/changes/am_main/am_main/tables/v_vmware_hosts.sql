...
-- changeset AM_MAIN:1774600127947 stripComments:false logicalFilePath:am_main/am_main/tables/v_vmware_hosts.sql runAlways:false runOnChange:false replaceIfExists:true failOnError:true
