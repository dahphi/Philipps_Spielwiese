...
-- changeset AM_MAIN:1774600126592 stripComments:false logicalFilePath:am_main/am_main/tables/hwas_rufbereitschaft.sql runAlways:false runOnChange:false replaceIfExists:true failOnError:true
