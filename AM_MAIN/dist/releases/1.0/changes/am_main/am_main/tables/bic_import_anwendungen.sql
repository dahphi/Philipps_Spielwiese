...
-- changeset AM_MAIN:1774600123366 stripComments:false logicalFilePath:am_main/am_main/tables/bic_import_anwendungen.sql runAlways:false runOnChange:false replaceIfExists:true failOnError:true
