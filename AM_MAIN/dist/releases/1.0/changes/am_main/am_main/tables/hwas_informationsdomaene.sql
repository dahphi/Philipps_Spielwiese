...
-- changeset AM_MAIN:1774600125314 stripComments:false logicalFilePath:am_main/am_main/tables/hwas_informationsdomaene.sql runAlways:false runOnChange:false replaceIfExists:true failOnError:true
