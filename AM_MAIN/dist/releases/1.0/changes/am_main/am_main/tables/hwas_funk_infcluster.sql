...
-- changeset AM_MAIN:1774600124396 stripComments:false logicalFilePath:am_main/am_main/tables/hwas_funk_infcluster.sql runAlways:false runOnChange:false replaceIfExists:true failOnError:true
