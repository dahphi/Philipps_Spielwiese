...
-- changeset AM_MAIN:1774600126774 stripComments:false logicalFilePath:am_main/am_main/tables/hwas_test_import_2.sql runAlways:false runOnChange:false replaceIfExists:true failOnError:true
-- sqlcl_snapshot AM_MAIN/src/database/am_main/tables/hwas_test_import_2.sql:null:9f754d356d579522b74d92b50338b2bb2850a7c3:create

create table am_main.hwas_test_import_2 (
