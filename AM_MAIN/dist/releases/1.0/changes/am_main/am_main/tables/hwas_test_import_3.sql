...
-- changeset AM_MAIN:1774600126837 stripComments:false logicalFilePath:am_main/am_main/tables/hwas_test_import_3.sql runAlways:false runOnChange:false replaceIfExists:true failOnError:true
-- sqlcl_snapshot AM_MAIN/src/database/am_main/tables/hwas_test_import_3.sql:null:cf68410e9ac3ec559ab22b95090429fca081aec8:create

create table am_main.hwas_test_import_3 (
