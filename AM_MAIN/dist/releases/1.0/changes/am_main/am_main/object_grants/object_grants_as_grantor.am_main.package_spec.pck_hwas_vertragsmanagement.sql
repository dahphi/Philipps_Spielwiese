...
-- changeset AM_MAIN:1774600099951 stripComments:false logicalFilePath:am_main/am_main/object_grants/object_grants_as_grantor.am_main.package_spec.pck_hwas_vertragsmanagement.sql runAlways:false runOnChange:false replaceIfExists:true failOnError:true
