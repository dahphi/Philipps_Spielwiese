...
-- changeset am_main:1774556567666 stripComments:false logicalFilePath:SCDP/am_main/comments/hwas_tk_technologie.sql runAlways:false runOnChange:false replaceIfExists:true failOnError:true
