...
-- changeset am_main:1774556567254 stripComments:false logicalFilePath:SCDP/am_main/comments/hwas_anlagenkategorie_e3.sql runAlways:false runOnChange:false replaceIfExists:true failOnError:true
