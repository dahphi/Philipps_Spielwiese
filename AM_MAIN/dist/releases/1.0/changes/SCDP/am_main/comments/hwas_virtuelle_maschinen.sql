...
-- changeset am_main:1774556567692 stripComments:false logicalFilePath:SCDP/am_main/comments/hwas_virtuelle_maschinen.sql runAlways:false runOnChange:false replaceIfExists:true failOnError:true
