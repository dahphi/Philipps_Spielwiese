...
-- changeset AM_MAIN:1774556574256 stripComments:false logicalFilePath:SCDP/am_main/object_grants/object_grants_as_grantor.awh_main.view.v_hwas_awh_tab_schutz_verfuegbar.sql runAlways:false runOnChange:false replaceIfExists:true failOnError:true
