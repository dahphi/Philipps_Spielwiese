...
-- changeset AM_MAIN:1774556574288 stripComments:false logicalFilePath:SCDP/am_main/object_grants/object_grants_as_grantor.core.table.logs.sql runAlways:false runOnChange:false replaceIfExists:true failOnError:true
