...
-- changeset AM_MAIN:1774556574299 stripComments:false logicalFilePath:SCDP/am_main/object_grants/object_grants_as_grantor.core.table.members_ad_hr.sql runAlways:false runOnChange:false replaceIfExists:true failOnError:true
