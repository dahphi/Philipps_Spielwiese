...
-- changeset AM_MAIN:1774556573722 stripComments:false logicalFilePath:SCDP/am_main/tables/sap_import_prod.sql runAlways:false runOnChange:false replaceIfExists:true failOnError:true
