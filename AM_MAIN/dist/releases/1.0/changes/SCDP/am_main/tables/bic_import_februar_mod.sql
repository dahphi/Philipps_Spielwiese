...
-- changeset AM_MAIN:1774556572550 stripComments:false logicalFilePath:SCDP/am_main/tables/bic_import_februar_mod.sql runAlways:false runOnChange:false replaceIfExists:true failOnError:true
