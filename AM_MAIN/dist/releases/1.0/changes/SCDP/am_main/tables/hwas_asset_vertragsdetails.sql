...
-- changeset AM_MAIN:1774556572619 stripComments:false logicalFilePath:SCDP/am_main/tables/hwas_asset_vertragsdetails.sql runAlways:false runOnChange:false replaceIfExists:true failOnError:true
