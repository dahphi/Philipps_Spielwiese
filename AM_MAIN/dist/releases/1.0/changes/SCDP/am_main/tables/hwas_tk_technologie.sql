...
-- changeset AM_MAIN:1774556573468 stripComments:false logicalFilePath:SCDP/am_main/tables/hwas_tk_technologie.sql runAlways:false runOnChange:false replaceIfExists:true failOnError:true
