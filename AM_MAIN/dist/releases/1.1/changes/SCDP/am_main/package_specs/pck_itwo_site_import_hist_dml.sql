...
-- changeset AM_MAIN:1774557120326 stripComments:false logicalFilePath:SCDP/am_main/package_specs/pck_itwo_site_import_hist_dml.sql runAlways:false runOnChange:false replaceIfExists:true failOnError:true
