...
-- changeset AM_MAIN:1774557120331 stripComments:false logicalFilePath:SCDP/am_main/package_specs/pkg_bic_import.sql runAlways:false runOnChange:false replaceIfExists:true failOnError:true
