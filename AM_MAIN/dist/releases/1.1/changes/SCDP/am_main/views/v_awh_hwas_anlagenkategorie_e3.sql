...
-- changeset AM_MAIN:1774557122170 stripComments:false logicalFilePath:SCDP/am_main/views/v_awh_hwas_anlagenkategorie_e3.sql runAlways:false runOnChange:false replaceIfExists:true failOnError:true
