...
-- changeset AM_MAIN:1774557122305 stripComments:false logicalFilePath:SCDP/am_main/views/v_awh_hwas_tk_technologie.sql runAlways:false runOnChange:false replaceIfExists:true failOnError:true
