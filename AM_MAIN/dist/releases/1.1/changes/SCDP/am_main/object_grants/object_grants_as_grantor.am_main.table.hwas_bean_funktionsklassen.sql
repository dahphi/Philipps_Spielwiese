...
-- changeset AM_MAIN:1774557115751 stripComments:false logicalFilePath:SCDP/am_main/object_grants/object_grants_as_grantor.am_main.table.hwas_bean_funktionsklassen.sql runAlways:false runOnChange:false replaceIfExists:true failOnError:true
