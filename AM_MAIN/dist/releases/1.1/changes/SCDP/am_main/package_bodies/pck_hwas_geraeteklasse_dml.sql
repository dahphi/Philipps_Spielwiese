...
-- changeset AM_MAIN:1774557117367 stripComments:false logicalFilePath:SCDP/am_main/package_bodies/pck_hwas_geraeteklasse_dml.sql runAlways:false runOnChange:false replaceIfExists:true failOnError:true
