...
-- changeset AM_MAIN:1774557119866 stripComments:false logicalFilePath:SCDP/am_main/package_bodies/pkg_sap_bestellungen_import.sql runAlways:false runOnChange:false replaceIfExists:true failOnError:true
