...
-- changeset AM_MAIN:1774557120652 stripComments:false logicalFilePath:SCDP/am_main/synonyms/v_itwo_raum.sql runAlways:false runOnChange:false replaceIfExists:true failOnError:true
