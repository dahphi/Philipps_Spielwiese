...
-- changeset AM_MAIN:1774557120593 stripComments:false logicalFilePath:SCDP/am_main/synonyms/ad.sql runAlways:false runOnChange:false replaceIfExists:true failOnError:true
