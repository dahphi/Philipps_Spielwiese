...
-- changeset am_main:1774557115158 stripComments:false logicalFilePath:SCDP/am_main/comments/hwas_betriebsinterner_prozess.sql runAlways:false runOnChange:false replaceIfExists:true failOnError:true
