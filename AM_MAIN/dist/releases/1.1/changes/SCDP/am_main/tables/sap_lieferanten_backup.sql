...
-- changeset AM_MAIN:1774557121960 stripComments:false logicalFilePath:SCDP/am_main/tables/sap_lieferanten_backup.sql runAlways:false runOnChange:false replaceIfExists:true failOnError:true
