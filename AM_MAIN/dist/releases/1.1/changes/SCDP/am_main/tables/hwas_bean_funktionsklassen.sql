...
-- changeset AM_MAIN:1774557120831 stripComments:false logicalFilePath:SCDP/am_main/tables/hwas_bean_funktionsklassen.sql runAlways:false runOnChange:false replaceIfExists:true failOnError:true
