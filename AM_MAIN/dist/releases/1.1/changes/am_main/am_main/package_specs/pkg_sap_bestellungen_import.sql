...
-- changeset AM_MAIN:1774605607122 stripComments:false logicalFilePath:am_main/am_main/package_specs/pkg_sap_bestellungen_import.sql runAlways:false runOnChange:false replaceIfExists:true failOnError:true
